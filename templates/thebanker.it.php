<!-- THE BANKER -->
<section id="the_banker" class="section blue-dark">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p class="white-text right-text">
                            ...
                            Web Opera Series<br />
                            Un progetto originale di <strong>Alberto Cara</strong> and <strong>Stefano Simone Pintor</strong><br />
                            ...
                            <br /><br />
                            Sponsor tecnico – <strong>VAS, Cavalli Musica</strong><br />
                            Si ringraziano – Davide Montorio, Ian Burton, Mara Andreetto, Ekaterina Zimina, Ginevra Danielli, Emma Buccelloni e Giancarlo Montorio, il sindaco dott. Gino Spiota e tutto il comune di Monastero Bormida (AT).
                        </p>
                    </div>
                </div>
                <div class="row">
                    <header>
                        <h2>THE</h2>
                        <h1>BANKER</h1>
                        <h3>web opera series</h3>
                    </header>
                </div>
            </div>
        </div>
    </div>
    <div id="banker_modal" style="display: none;">
        <h1>The Banker</h1>
        <p class="justify">
