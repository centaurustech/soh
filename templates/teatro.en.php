<!-- TEATRO -->
<section id="teatro" class="section orange">
    <div class="container-fluid">
        <div class='row'>
            <h1>THE THEATRE</h1>
            <div class="col-md-2 hidden-xs"></div>
            <div class="col-md-4 col-xs-12 text-section">
                <h1>The Other Dimension of Theatre</h1>
                <p class="justify">
                    The Social Opera House is the first fully virtual opera theatre ever made: it doesn’t have a physical location, it only and solely exists online. <br />
        ...
        <div class="row">
            <img src="images/teatropc.png" alt="Il Teatro" class="img-responsive img-teatro"/>
        </div>
        <div class="row">
