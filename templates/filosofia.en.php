    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-12 text-section">
                <h1>After all, as Cechov used to say...</h1>
                <p class="justify">
                    "We need new forms of expression. We need new forms, and if we can't have them we had better have nothing."
                    Therefore: may the curtains open to this new quest! How will the theatre of the future be? Will it still be called "theatre"? Or will it be a new genre, capable of merging writing, music, dance, figurative arts, cinema, but also science, technology, physical, augmented and virtual realities?<br />
                </p>
            </div>
